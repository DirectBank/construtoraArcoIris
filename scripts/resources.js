...
const TARGET_GOOGLE_SERVICES = 'android/app/google-service.json';
...
const NOTIFICATION = [
  { source: "drawable-hdpi-icon.png", target: "drawable-hdpi/fcm_push_icon.png" },
  { source: "drawable-mdpi-icon.png", target: "drawable-mdpi/fcm_push_icon.png" },
  { source: "drawable-xhdpi-icon.png", target: "drawable-xhdpi/fcm_push_icon.png" },
  { source: "drawable-xxhdpi-icon.png", target: "drawable-xxhdpi/fcm_push_icon.png" },
  { source: "drawable-xxxhdpi-icon.png", target: "drawable-xxxhdpi/fcm_push_icon.png" }
];
